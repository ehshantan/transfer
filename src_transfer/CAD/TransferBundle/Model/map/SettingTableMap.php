...
class SettingTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src_transfer.CAD.TransferBundle.Model.map.SettingTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('CAD\\TransferBundle\\Model\\Setting');
        $this->setPackage('src_transfer.CAD.TransferBundle.Model');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'BIGINT', true, null, null);
        $this->addColumn('email_cc', 'EmailCc', 'LONGVARCHAR', true, null, null);
        // validators
    } // initialize()
