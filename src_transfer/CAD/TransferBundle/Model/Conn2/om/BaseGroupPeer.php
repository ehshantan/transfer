...
use \PropelException;
use \PropelPDO;
use CAD\TransferBundle\Model\Conn2\Group;
use CAD\TransferBundle\Model\Conn2\GroupPeer;
use CAD\TransferBundle\Model\Conn2\map\GroupTableMap;
...
abstract class BaseGroupPeer
{
    ...
    const OM_CLASS = 'CAD\\TransferBundle\\Model\\Conn2\\Group';

    /** the related TableMap class for this table */
    const TM_CLASS = 'CAD\\TransferBundle\\Model\\Conn2\\map\\GroupTableMap';
    ...
    protected static $fieldNames = array(
        ...
        BasePeer::TYPE_COLNAME => array(GroupPeer::ID, GroupPeer::NAME, GroupPeer::ACTIVE,),
    ...
    protected static $fieldKeys = array(
        ...
        BasePeer::TYPE_COLNAME => array(GroupPeer::ID => 0, GroupPeer::NAME => 1, GroupPeer::ACTIVE => 2,),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(GroupPeer::ACTIVE);
        } else {
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof Group) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or Group object; got " . (is_object(
                    $value
    ...
    public static function buildTableMap()
    {
        ...
        if (!$dbMap->hasTable(BaseGroupPeer::TABLE_NAME)) {
            $dbMap->addTableObject(new \CAD\TransferBundle\Model\Conn2\map\GroupTableMap());
        }
    }
