...
use CAD\TransferBundle\Model\Conn2\BatchQuery;
...
abstract class BaseBatch extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'CAD\\TransferBundle\\Model\\Conn2\\BatchPeer';
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BatchPeer::NAME)) {
            $criteria->add(BatchPeer::NAME, $this->name);
        }
        if ($this->isColumnModified(BatchPeer::ACTIVE)) {
            $criteria->add(BatchPeer::ACTIVE, $this->active);
        }
