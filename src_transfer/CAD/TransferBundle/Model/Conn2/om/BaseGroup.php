...
use CAD\TransferBundle\Model\Conn2\GroupQuery;
...
abstract class BaseGroup extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'CAD\\TransferBundle\\Model\\Conn2\\GroupPeer';
    ...
    public function setActive($v)
    {
        ...
        if ($this->active !== $v) {
            $this->active = $v;
            $this->modifiedColumns[] = GroupPeer::ACTIVE;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(GroupPeer::ACTIVE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GroupPeer::NAME)) {
            $criteria->add(GroupPeer::NAME, $this->name);
        }
        if ($this->isColumnModified(GroupPeer::ACTIVE)) {
            $criteria->add(GroupPeer::ACTIVE, $this->active);
        }
