...
use CAD\TransferBundle\Model\Conn1\map\PdnTugasDetailTableMap;
...
abstract class BasePdnTugasDetailPeer
{
    ...
    const OM_CLASS = 'CAD\\TransferBundle\\Model\\Conn1\\PdnTugasDetail';

    /** the related TableMap class for this table */
    const TM_CLASS = 'CAD\\TransferBundle\\Model\\Conn1\\map\\PdnTugasDetailTableMap';
    ...
    public static function buildTableMap()
    {
        ...
        if (!$dbMap->hasTable(BasePdnTugasDetailPeer::TABLE_NAME)) {
            $dbMap->addTableObject(new \CAD\TransferBundle\Model\Conn1\map\PdnTugasDetailTableMap());
        }
    }
