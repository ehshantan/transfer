...
use CAD\TransferBundle\Model\Conn1\map\TrabsensiTableMap;
...
abstract class BaseTrabsensiPeer
{
    ...
    const OM_CLASS = 'CAD\\TransferBundle\\Model\\Conn1\\Trabsensi';

    /** the related TableMap class for this table */
    const TM_CLASS = 'CAD\\TransferBundle\\Model\\Conn1\\map\\TrabsensiTableMap';
    ...
    public static function buildTableMap()
    {
        ...
        if (!$dbMap->hasTable(BaseTrabsensiPeer::TABLE_NAME)) {
            $dbMap->addTableObject(new \CAD\TransferBundle\Model\Conn1\map\TrabsensiTableMap());
        }
    }
