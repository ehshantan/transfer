...
use CAD\TransferBundle\Model\Conn1\map\PdnEmailSettingTableMap;
...
abstract class BasePdnEmailSettingPeer
{
    ...
    const OM_CLASS = 'CAD\\TransferBundle\\Model\\Conn1\\PdnEmailSetting';

    /** the related TableMap class for this table */
    const TM_CLASS = 'CAD\\TransferBundle\\Model\\Conn1\\map\\PdnEmailSettingTableMap';
    ...
    public static function buildTableMap()
    {
        ...
        if (!$dbMap->hasTable(BasePdnEmailSettingPeer::TABLE_NAME)) {
            $dbMap->addTableObject(new \CAD\TransferBundle\Model\Conn1\map\PdnEmailSettingTableMap());
        }
    }
