 ...
 * @method GroupQuery orderByActive($order = Criteria::ASC) Order by the active column
 *
 * @method GroupQuery groupById() Group by the id column
 * @method GroupQuery groupByName() Group by the name column
 * @method GroupQuery groupByActive() Group by the active column
 *
 ...
 * @method Group findOneByActive(boolean $active) Return the first Group filtered by the active column
 *
 * @method array findById(string $id) Return Group objects filtered by the id column
 * @method array findByName(string $name) Return Group objects filtered by the name column
 * @method array findByActive(boolean $active) Return Group objects filtered by the active column
 */
abstract class BaseGroupQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'CAD\\TransferBundle\\Model\\Conn1\\Group';
        }
    ...
    {
        $sql = 'SELECT `id`, `name`, `active` FROM `group` WHERE `id` = :p0';
        try {
    ...
    public function filterByActive($active = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(GroupPeer::ACTIVE, $active, $comparison);
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \CAD\TransferBundle\Model\Conn1\UserQuery A secondary query class using the current class as primary query
     */
    public function useUserQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinUser($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'User', '\CAD\TransferBundle\Model\Conn1\UserQuery');
    }
