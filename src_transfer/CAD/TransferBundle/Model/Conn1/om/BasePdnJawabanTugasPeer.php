...
use \PropelException;
use \PropelPDO;
use CAD\TransferBundle\Model\Conn1\PdnJawabanTugas;
use CAD\TransferBundle\Model\Conn1\PdnJawabanTugasPeer;
use CAD\TransferBundle\Model\Conn1\map\PdnJawabanTugasTableMap;
...
abstract class BasePdnJawabanTugasPeer
{
    ...
    const OM_CLASS = 'CAD\\TransferBundle\\Model\\Conn1\\PdnJawabanTugas';

    /** the related TableMap class for this table */
    const TM_CLASS = 'CAD\\TransferBundle\\Model\\Conn1\\map\\PdnJawabanTugasTableMap';
    ...
    public static function buildTableMap()
    {
        ...
        if (!$dbMap->hasTable(BasePdnJawabanTugasPeer::TABLE_NAME)) {
            $dbMap->addTableObject(new \CAD\TransferBundle\Model\Conn1\map\PdnJawabanTugasTableMap());
        }
    }
