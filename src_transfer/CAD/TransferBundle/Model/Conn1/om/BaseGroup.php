...
abstract class BaseGroup extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'CAD\\TransferBundle\\Model\\Conn1\\GroupPeer';
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GroupPeer::ACTIVE)) $criteria->add(GroupPeer::ACTIVE, $this->active);
     ...
     * @return PropelObjectCollection|User[] List of User objects
     */
    public function getUsersJoinBatch($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = UserQuery::create(null, $criteria);
