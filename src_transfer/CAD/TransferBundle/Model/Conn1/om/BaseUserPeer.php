...
use CAD\TransferBundle\Model\Conn1\GroupPeer;
use CAD\TransferBundle\Model\Conn1\User;
use CAD\TransferBundle\Model\Conn1\UserPeer;
use CAD\TransferBundle\Model\Conn1\map\UserTableMap;
...
abstract class BaseUserPeer
{
    ...
    const OM_CLASS = 'CAD\\TransferBundle\\Model\\Conn1\\User';

    /** the related TableMap class for this table */
    const TM_CLASS = 'CAD\\TransferBundle\\Model\\Conn1\\map\\UserTableMap';
    ...
    const HANDPHONE = 'user.handphone';

    /** the column name for the hall field */
    const HALL = 'user.hall';
    ...
    protected static $fieldKeys = array(
        ...
        BasePeer::TYPE_COLNAME => array(
            ...
            UserPeer::NAME => 1,
            UserPeer::BATCH_ID => 2,
            UserPeer::BIRTHDATE => 3,
            UserPeer::BIRTHPLACE => 4,
            UserPeer::EMAIL => 5,
            UserPeer::PASSWORD => 6,
            UserPeer::ADDRESS => 7,
            UserPeer::PHONE => 8,
            UserPeer::HANDPHONE => 9,
            UserPeer::HALL => 10,
            UserPeer::GROUP_ID => 11,
            UserPeer::ROLES => 12,
            UserPeer::ACTIVE => 13,
        ),
        BasePeer::TYPE_RAW_COLNAME => array(
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserPeer::BATCH_ID);
            $criteria->addSelectColumn(UserPeer::BIRTHDATE);
            $criteria->addSelectColumn(UserPeer::BIRTHPLACE);
            ...
            $criteria->addSelectColumn(UserPeer::HANDPHONE);
            $criteria->addSelectColumn(UserPeer::HALL);
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof User) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or User object; got " . (is_object(
                    $value
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinGroup(
        Criteria $criteria,
        $distinct = false,
        PropelPDO $con = null,
    ...
    public static function doCountJoinBatch(
        ...
        $criteria->addJoin(UserPeer::BATCH_ID, BatchPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of User objects pre-filled with their Batch objects.
     * @param      Criteria $criteria
     * @param      PropelPDO $con
     * @param      String $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of User objects.
    ...
    public static function doSelectJoinBatch(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (User) to $obj2 (Batch)
                $obj2->addUser($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        BatchPeer::addSelectColumns($criteria);
        $startcol4 = $startcol3 + BatchPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $key3 = BatchPeer::getPrimaryKeyHashFromRow($row, $startcol3);
            if ($key3 !== null) {
                $obj3 = BatchPeer::getInstanceFromPool($key3);
                if (!$obj3) {
                    ...
                    BatchPeer::addInstanceToPool($obj3, $key3);
                } // if obj3 loaded

                // Add the $obj1 (User) to the collection in $obj3 (Batch)
                $obj3->addUser($obj1);
            } // if joined row not null
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinAllExceptGroup(
        Criteria $criteria,
        $distinct = false,
        PropelPDO $con = null,
        $join_behavior = Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of User objects pre-filled with all related objects except Group.
     *
     * @param      Criteria $criteria
     * @param      PropelPDO $con
     * @param      String $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     ...
     *         rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinAllExceptGroup(
        Criteria $criteria,
        $con = null,
        $join_behavior = Criteria::LEFT_JOIN
    ) {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (User) to the collection in $obj2 (Batch)
                $obj2->addUser($obj1);
    ...
    /**
     * Selects a collection of User objects pre-filled with all related objects except Batch.
     *
     * @param      Criteria $criteria
     * @param      PropelPDO $con
     * @param      String $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function buildTableMap()
    {
        ...
        if (!$dbMap->hasTable(BaseUserPeer::TABLE_NAME)) {
            $dbMap->addTableObject(new \CAD\TransferBundle\Model\Conn1\map\UserTableMap());
        }
    }
