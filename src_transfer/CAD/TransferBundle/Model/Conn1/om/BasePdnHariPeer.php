...
use CAD\TransferBundle\Model\Conn1\map\PdnHariTableMap;
...
abstract class BasePdnHariPeer
{
    ...
    const OM_CLASS = 'CAD\\TransferBundle\\Model\\Conn1\\PdnHari';

    /** the related TableMap class for this table */
    const TM_CLASS = 'CAD\\TransferBundle\\Model\\Conn1\\map\\PdnHariTableMap';
    ...
    public static function buildTableMap()
    {
        ...
        if (!$dbMap->hasTable(BasePdnHariPeer::TABLE_NAME)) {
            $dbMap->addTableObject(new \CAD\TransferBundle\Model\Conn1\map\PdnHariTableMap());
        }
    }
