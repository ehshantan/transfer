...
class PdnPertanyaanUmumTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src_transfer.CAD.TransferBundle.Model.Conn1.map.PdnPertanyaanUmumTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('CAD\\TransferBundle\\Model\\Conn1\\PdnPertanyaanUmum');
