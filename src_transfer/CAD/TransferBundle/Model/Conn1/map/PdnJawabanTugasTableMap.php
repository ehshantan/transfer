...
class PdnJawabanTugasTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src_transfer.CAD.TransferBundle.Model.Conn1.map.PdnJawabanTugasTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('CAD\\TransferBundle\\Model\\Conn1\\PdnJawabanTugas');
