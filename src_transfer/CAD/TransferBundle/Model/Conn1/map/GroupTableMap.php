...
class GroupTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src_transfer.CAD.TransferBundle.Model.Conn1.map.GroupTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('CAD\\TransferBundle\\Model\\Conn1\\Group');
    ...
    public function buildRelations()
    {
        $this->addRelation(
            'User',
            'CAD\\TransferBundle\\Model\\Conn1\\User',
