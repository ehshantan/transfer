...
abstract class BaseCategoryJournalFieldType extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CAD\\TransferBundle\\Model\\CategoryJournalFieldTypePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CategoryJournalFieldTypePeer
     */
    ...
    /**
     * Initializes internal state of BaseCategoryJournalFieldType object.
     * @see        applyDefaults()
     */
     ...
     * @return CategoryJournalFieldType The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CategoryJournalFieldTypePeer::ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = CategoryJournalFieldTypePeer::NAME;
        }
    ...
    public function setActive($v)
    {
        ...
        if ($this->active !== $v) {
            $this->active = $v;
            $this->modifiedColumns[] = CategoryJournalFieldTypePeer::ACTIVE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = CategoryJournalFieldTypePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CategoryJournalFieldType object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CategoryJournalFieldTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CategoryJournalFieldTypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CategoryJournalFieldTypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CategoryJournalFieldTypePeer::ID)) {
            $modifiedColumns[':p' . $index++] = '`id`';
        }
        if ($this->isColumnModified(CategoryJournalFieldTypePeer::NAME)) {
            $modifiedColumns[':p' . $index++] = '`name`';
        }
        if ($this->isColumnModified(CategoryJournalFieldTypePeer::ACTIVE)) {
            $modifiedColumns[':p' . $index++] = '`active`';
        }

        $sql = sprintf(
            'INSERT INTO `category_journal_field_type` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CategoryJournalFieldTypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CategoryJournalFieldTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function toArray(
        ...
        if (isset($alreadyDumpedObjects['CategoryJournalFieldType'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CategoryJournalFieldType'][$this->getPrimaryKey()] = true;
        $keys = CategoryJournalFieldTypePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CategoryJournalFieldTypePeer::ID)) $criteria->add(
            CategoryJournalFieldTypePeer::ID,
            $this->id
        );
        if ($this->isColumnModified(CategoryJournalFieldTypePeer::NAME)) $criteria->add(
            CategoryJournalFieldTypePeer::NAME,
            $this->name
        );
        if ($this->isColumnModified(CategoryJournalFieldTypePeer::ACTIVE)) $criteria->add(
    ...
    {
        $criteria = new Criteria(CategoryJournalFieldTypePeer::DATABASE_NAME);
        $criteria->add(CategoryJournalFieldTypePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CategoryJournalFieldType (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CategoryJournalFieldType Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CategoryJournalFieldTypePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CategoryJournalFieldTypePeer();
        }
     ...
     * If this CategoryJournalFieldType is new, it will return
        ...
        if (null === $this->collCategoryJournalFields || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collCategoryJournalFields) {
                ...
                $collCategoryJournalFields = CategoryJournalFieldQuery::create(null, $criteria)
                    ->filterByCategoryJournalFieldType($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setCategoryJournalFields(PropelCollection $categoryJournalFields, PropelPDO $con = null)
    {
        ...
        foreach ($categoryJournalFieldsToDelete as $categoryJournalFieldRemoved) {
            $categoryJournalFieldRemoved->setCategoryJournalFieldType(null);
        }
    ...
    protected function doAddCategoryJournalField($categoryJournalField)
    {
        ...
        $categoryJournalField->setCategoryJournalFieldType($this);
    }
    ...
    public function removeCategoryJournalField($categoryJournalField)
    {
        if ($this->getCategoryJournalFields()->contains($categoryJournalField)) {
            ...
            $categoryJournalField->setCategoryJournalFieldType(null);
        }
     ...
     * Otherwise if this CategoryJournalFieldType is new, it will return
     * an empty collection; or if this CategoryJournalFieldType has previously
     * been saved, it will retrieve related CategoryJournalFields from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CategoryJournalFieldType.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|CategoryJournalField[] List of CategoryJournalField objects
     */
    public function getCategoryJournalFieldsJoinCategoryJournal(
        $criteria = null,
        $con = null,
    ...
    {
        return (string)$this->exportTo(CategoryJournalFieldTypePeer::DEFAULT_STRING_FORMAT);
    }
