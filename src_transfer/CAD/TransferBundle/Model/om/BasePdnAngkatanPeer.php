...
use CAD\TransferBundle\Model\map\PdnAngkatanTableMap;
...
abstract class BasePdnAngkatanPeer
{
    ...
    const OM_CLASS = 'CAD\\TransferBundle\\Model\\PdnAngkatan';

    /** the related TableMap class for this table */
    const TM_CLASS = 'CAD\\TransferBundle\\Model\\map\\PdnAngkatanTableMap';
    ...
    public static function buildTableMap()
    {
        ...
        if (!$dbMap->hasTable(BasePdnAngkatanPeer::TABLE_NAME)) {
            $dbMap->addTableObject(new \CAD\TransferBundle\Model\map\PdnAngkatanTableMap());
        }
    }
