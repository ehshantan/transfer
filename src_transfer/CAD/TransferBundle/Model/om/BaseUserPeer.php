...
use CAD\TransferBundle\Model\GroupPeer;
use CAD\TransferBundle\Model\User;
use CAD\TransferBundle\Model\UserPeer;
use CAD\TransferBundle\Model\map\UserTableMap;
...
abstract class BaseUserPeer
{
    ...
    const OM_CLASS = 'CAD\\TransferBundle\\Model\\User';

    /** the related TableMap class for this table */
    const TM_CLASS = 'CAD\\TransferBundle\\Model\\map\\UserTableMap';
    ...
    public static function buildTableMap()
    {
        ...
        if (!$dbMap->hasTable(BaseUserPeer::TABLE_NAME)) {
            $dbMap->addTableObject(new \CAD\TransferBundle\Model\map\UserTableMap());
        }
    }
