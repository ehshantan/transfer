...
use CAD\TransferBundle\Model\map\GroupTableMap;
...
abstract class BaseGroupPeer
{
    ...
    const OM_CLASS = 'CAD\\TransferBundle\\Model\\Group';

    /** the related TableMap class for this table */
    const TM_CLASS = 'CAD\\TransferBundle\\Model\\map\\GroupTableMap';
    ...
    public static function buildTableMap()
    {
        ...
        if (!$dbMap->hasTable(BaseGroupPeer::TABLE_NAME)) {
            $dbMap->addTableObject(new \CAD\TransferBundle\Model\map\GroupTableMap());
        }
    }
