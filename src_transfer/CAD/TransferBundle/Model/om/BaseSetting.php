...
use CAD\TransferBundle\Model\SettingQuery;
...
abstract class BaseSetting extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'CAD\\TransferBundle\\Model\\SettingPeer';
    ...
    public function setEmailCc($v)
    {
        ...
        if ($this->email_cc !== $v) {
            $this->email_cc = $v;
            $this->modifiedColumns[] = SettingPeer::EMAIL_CC;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->email_cc = ($row[$startcol + 1] !== null) ? (string)$row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = SettingPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SettingPeer::EMAIL_CC)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SettingPeer::EMAIL_CC)) {
            $criteria->add(SettingPeer::EMAIL_CC, $this->email_cc);
        }
