 ...
 * @method SettingQuery orderByEmailCc($order = Criteria::ASC) Order by the email_cc column
 *
 * @method SettingQuery groupById() Group by the id column
 * @method SettingQuery groupByEmailCc() Group by the email_cc column
 *
 ...
 *
 * @method Setting findOneByEmailCc(string $email_cc) Return the first Setting filtered by the email_cc column
 *
 * @method array findById(string $id) Return Setting objects filtered by the id column
 * @method array findByEmailCc(string $email_cc) Return Setting objects filtered by the email_cc column
 */
abstract class BaseSettingQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'CAD\\TransferBundle\\Model\\Setting';
        }
    ...
    {
        $sql = 'SELECT `id`, `email_cc` FROM `setting` WHERE `id` = :p0';
        try {
    ...
    public function filterByEmailCc($emailCc = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SettingPeer::EMAIL_CC, $emailCc, $comparison);
    }
