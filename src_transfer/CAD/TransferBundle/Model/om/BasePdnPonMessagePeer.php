...
use CAD\TransferBundle\Model\map\PdnPonMessageTableMap;
...
abstract class BasePdnPonMessagePeer
{
    ...
    const OM_CLASS = 'CAD\\TransferBundle\\Model\\PdnPonMessage';

    /** the related TableMap class for this table */
    const TM_CLASS = 'CAD\\TransferBundle\\Model\\map\\PdnPonMessageTableMap';
    ...
    public static function buildTableMap()
    {
        ...
        if (!$dbMap->hasTable(BasePdnPonMessagePeer::TABLE_NAME)) {
            $dbMap->addTableObject(new \CAD\TransferBundle\Model\map\PdnPonMessageTableMap());
        }
    }
