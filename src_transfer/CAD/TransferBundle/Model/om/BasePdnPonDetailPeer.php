...
use CAD\TransferBundle\Model\map\PdnPonDetailTableMap;
...
abstract class BasePdnPonDetailPeer
{
    ...
    const OM_CLASS = 'CAD\\TransferBundle\\Model\\PdnPonDetail';

    /** the related TableMap class for this table */
    const TM_CLASS = 'CAD\\TransferBundle\\Model\\map\\PdnPonDetailTableMap';
    ...
    public static function buildTableMap()
    {
        ...
        if (!$dbMap->hasTable(BasePdnPonDetailPeer::TABLE_NAME)) {
            $dbMap->addTableObject(new \CAD\TransferBundle\Model\map\PdnPonDetailTableMap());
        }
    }
