...
use \PropelException;
use \PropelPDO;
use CAD\TransferBundle\Model\Setting;
use CAD\TransferBundle\Model\SettingPeer;
use CAD\TransferBundle\Model\map\SettingTableMap;
...
abstract class BaseSettingPeer
{
    ...
    const OM_CLASS = 'CAD\\TransferBundle\\Model\\Setting';

    /** the related TableMap class for this table */
    const TM_CLASS = 'CAD\\TransferBundle\\Model\\map\\SettingTableMap';
    ...
    const EMAIL_CC = 'setting.email_cc';
    ...
    protected static $fieldNames = array(
        BasePeer::TYPE_PHPNAME => array('Id', 'EmailCc',),
        BasePeer::TYPE_STUDLYPHPNAME => array('id', 'emailCc',),
        BasePeer::TYPE_COLNAME => array(SettingPeer::ID, SettingPeer::EMAIL_CC,),
        BasePeer::TYPE_RAW_COLNAME => array('ID', 'EMAIL_CC',),
        BasePeer::TYPE_FIELDNAME => array('id', 'email_cc',),
    ...
    protected static $fieldKeys = array(
        BasePeer::TYPE_PHPNAME => array('Id' => 0, 'EmailCc' => 1,),
        BasePeer::TYPE_STUDLYPHPNAME => array('id' => 0, 'emailCc' => 1,),
        BasePeer::TYPE_COLNAME => array(SettingPeer::ID => 0, SettingPeer::EMAIL_CC => 1,),
        BasePeer::TYPE_RAW_COLNAME => array('ID' => 0, 'EMAIL_CC' => 1,),
        BasePeer::TYPE_FIELDNAME => array('id' => 0, 'email_cc' => 1,),
        BasePeer::TYPE_NUM => array(0, 1,)
    );
    ...
    public static function translateFieldName($name, $fromType, $toType)
    {
        ...
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(
                SettingPeer::$fieldKeys[$fromType],
                true
            ));
        }
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SettingPeer::EMAIL_CC);
        } else {
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof Setting) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or Setting object; got " . (is_object(
                    $value
    ...
    public static function buildTableMap()
    {
        ...
        if (!$dbMap->hasTable(BaseSettingPeer::TABLE_NAME)) {
            $dbMap->addTableObject(new \CAD\TransferBundle\Model\map\SettingTableMap());
        }
    }
